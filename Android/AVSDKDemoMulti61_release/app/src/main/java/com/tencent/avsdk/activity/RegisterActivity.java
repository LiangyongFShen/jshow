...
public class RegisterActivity extends Activity implements TextWatcher, View.OnClickListener {
	...
	private int accType = Integer.parseInt(Util.UID_TYPE);
	private int sdkAppid = Integer.parseInt(Util.APP_ID_TEXT);
...
//				if(0 == username.length())
	...
	public void onSmsRegister(View view) {
		...
		setAppId("1400001692", "884");
		accType = Integer.parseInt(Util.UID_TYPE);
		sdkAppid = Integer.parseInt(Util.APP_ID_TEXT);
	...
	public void setAppId(String id, String type){
		Util.APP_ID_TEXT = id;
		Util.UID_TYPE = type;
	}
