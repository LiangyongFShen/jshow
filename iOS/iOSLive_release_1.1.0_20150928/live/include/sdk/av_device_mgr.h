#ifndef AV_DEVICE_MGR_H_
#define AV_DEVICE_MGR_H_
...
class AV_EXPORT AVDeviceMgr {
  ...
  */
  typedef void (*DeviceOperationCallback)(AVDeviceMgr* device_mgr, DeviceOperation oper, const std::string& device_id,
  ...
  */
  ...
  DISALLOW_EVIL_DESTRUCTIONS(AVDeviceMgr)
};

} // namespace av
} // namespace tencent

#endif // #ifndef AV_DEVICE_MGR_H_